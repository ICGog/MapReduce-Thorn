===============================================================================
Thorn Interpreter v0.5 ("Fisher") Distribution
===============================================================================

STEP 1: Install Thorn
---------------------

Prerequisite: Ensure that Java 1.6 is installed on your system.

In the following, let thorn_root designate the directory connecting
the thorn interpreter distribution (i.e., the directory containing
this file).

To set up your system to run thorn, proceed as follows

- Define and export the following shell variables, e.g., in your
  system or shell startup file:

  export THORNROOT=thorn_root
...
NB: The commands above have been tested on Mac OSX and the bash shell;
they will need to be appropriately modified for other operating
systems or shells.

The bin directory contains two bash shell scripts, 'th' and 'threpl',
for invoking Java/fisher from the command line.  'th' is the
non-interactive thorn interpreter; 'threpl' is the interactive thorn
read-eval-print-loop interpreter.  The script for 'th' is simply:

  #!/bin/bash
  java -classpath $THORNJARS fisher.run.Thorn $*

You may need to modify the scripts to run on other shells.
