...
public  class QueryFirstlike extends QueryAbstract implements ProcMember {
 public  Cmd exp; 
 public  Cmd none; 
 public  boolean isExp; 
public QueryFirstlike(Token start, Token end, List<QueryControl> controls, Cmd actualCode, Cmd exp, Cmd none, boolean isExp){
...
public <ARG, RET,  EXN extends Exception> RET accept(Visitor<ARG,RET,  EXN> vis, ARG arg) throws EXN {
   return vis.visit((QueryFirstlike)this, arg);
}
public <ARG,  EXN extends Exception> void accept(Walker<ARG, EXN> vis, ARG arg) throws EXN {
    vis.visit((QueryFirstlike)this, arg);
}
	   ...
	   switch (field) {
        ...
        default:
         fisher.util.Doom.internalCatastrophe("bad field number in internalReplace", this, field, index, newval);
          ...
          public String genericName(){return "QueryFirstlike";}
        
public Syntax internalDeepCopy(Token start, Token end)  {
Syntax copy = new QueryFirstlike(start, end, (List<QueryControl>)(deepCopyList(controls, start, end)), 
