...
public  class FunCall extends Cmd implements ProcMember {
 public  Cmd function; 
public final List<Cmd> args;
public FunCall(Token start, Token end, Cmd function, List<Cmd> args){
    super(start, end);
...
public <ARG, RET,  EXN extends Exception> RET accept(Visitor<ARG,RET,  EXN> vis, ARG arg) throws EXN {
   return vis.visit((FunCall)this, arg);
}
public <ARG,  EXN extends Exception> void accept(Walker<ARG, EXN> vis, ARG arg) throws EXN {
    vis.visit((FunCall)this, arg);
}
	   ...
	   switch (field) {
        ...
        default:
         fisher.util.Doom.internalCatastrophe("bad field number in internalReplace", this, field, index, newval);
          ...
          public String genericName(){return "FunCall";}
        
public Syntax internalDeepCopy(Token start, Token end)  {
Syntax copy = new FunCall(start, end, 
