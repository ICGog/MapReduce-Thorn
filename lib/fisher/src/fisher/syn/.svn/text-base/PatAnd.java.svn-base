...
public  class PatAnd extends Pat implements ProcMember {
public final List<Pat> subpats;
public PatAnd(Token start, Token end, List<Pat> subpats){
    super(start, end);
    this.subpats = subpats;
for(Object o : subpats){children.add((Syntax)o);}
}
public <ARG, RET,  EXN extends Exception> RET accept(Visitor<ARG,RET,  EXN> vis, ARG arg) throws EXN {
   return vis.visit((PatAnd)this, arg);
}
public <ARG,  EXN extends Exception> void accept(Walker<ARG, EXN> vis, ARG arg) throws EXN {
    vis.visit((PatAnd)this, arg);
}
...
public <ARG1, ARG2, RET,  EXN extends Exception> RET accept(VisitPat2<ARG1, ARG2,RET,  EXN> vis, ARG1 arg1, ARG2 arg2) throws EXN {
   return vis.visit((PatAnd)this, arg1, arg2);
}
	   ...
	   switch (field) {
        ...
        default:
         fisher.util.Doom.internalCatastrophe("bad field number in internalReplace", this, field, index, newval);
          ...
          public String genericName(){return "PatAnd";}
        
public Syntax internalDeepCopy(Token start, Token end)  {
Syntax copy = new PatAnd(start, end, (List<Pat>)(deepCopyList(subpats, start, end)));
