...
public  class JavalyFun extends Javaly implements ModuleFileMember, ProcMember {
 public  Id name; 
public final List<Id> formals;
 public  QualName impl; 
public JavalyFun(Token start, Token end, Id name, List<Id> formals, QualName impl){
    super(start, end);
    this.name = name;
...
public <ARG, RET,  EXN extends Exception> RET accept(Visitor<ARG,RET,  EXN> vis, ARG arg) throws EXN {
   return vis.visit((JavalyFun)this, arg);
}
public <ARG,  EXN extends Exception> void accept(Walker<ARG, EXN> vis, ARG arg) throws EXN {
    vis.visit((JavalyFun)this, arg);
}
...
public String toString() {return 
  ...
  ;}
	   ...
	   switch (field) {
		 ...
		 case 2: this.impl = (QualName) newval; break;
        ...
        default:
         fisher.util.Doom.internalCatastrophe("bad field number in internalReplace", this, field, index, newval);
          ...
          public String genericName(){return "JavalyFun";}
        
public Syntax internalDeepCopy(Token start, Token end)  {
Syntax copy = new JavalyFun(start, end, 
(name == null ? null : (Id)name.internalDeepCopy(start,end)), (List<Id>)(deepCopyList(formals, start, end)), 
(impl == null ? null : (QualName)impl.internalDeepCopy(start,end)));
