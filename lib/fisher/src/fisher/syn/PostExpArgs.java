...
public  class PostExpArgs extends PostExp implements ProcMember {
public final List<Cmd> args;
public PostExpArgs(Token start, Token end, List<Cmd> args){
    super(start, end);
    this.args = args;
	   ...
	   switch (field) {
        ...
        default:
         fisher.util.Doom.internalCatastrophe("bad field number in internalReplace", this, field, index, newval);
          ...
          public String genericName(){return "PostExpArgs";}
        
public Syntax internalDeepCopy(Token start, Token end)  {
Syntax copy = new PostExpArgs(start, end, (List<Cmd>)(deepCopyList(args, start, end)));
