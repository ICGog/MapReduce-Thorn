...
public  class QueryQuantifierEvery extends QueryQuantifier implements ProcMember {

public QueryQuantifierEvery(Token start, Token end, List<QueryControl> controls, Cmd actualCode, Cmd pred){
    super(start, end, controls, actualCode, pred);
}
public <ARG, RET,  EXN extends Exception> RET accept(Visitor<ARG,RET,  EXN> vis, ARG arg) throws EXN {
   return vis.visit((QueryQuantifierEvery)this, arg);
}
public <ARG,  EXN extends Exception> void accept(Walker<ARG, EXN> vis, ARG arg) throws EXN {
    vis.visit((QueryQuantifierEvery)this, arg);
}
...
+ ")";}
public String toString() {return  "%every" + super.toString() ;}
	   ...
	   switch (field) {
        ...
        default:
         fisher.util.Doom.internalCatastrophe("bad field number in internalReplace", this, field, index, newval);
          ...
          public String genericName(){return "QueryQuantifierEvery";}
        
public Syntax internalDeepCopy(Token start, Token end)  {
Syntax copy = new QueryQuantifierEvery(start, end, (List<QueryControl>)(deepCopyList(controls, start, end)), 
