...
public  class EvalTestExpExp extends ForPatternOnly implements ProcMember {
 public  Cmd exp; 
public EvalTestExpExp(Token start, Token end, Cmd exp){
    super(start, end);
    this.exp = exp;
    if(exp != null) children.add(exp);
}
public <ARG, RET,  EXN extends Exception> RET accept(Visitor<ARG,RET,  EXN> vis, ARG arg) throws EXN {
   return vis.visit((EvalTestExpExp)this, arg);
}
public <ARG,  EXN extends Exception> void accept(Walker<ARG, EXN> vis, ARG arg) throws EXN {
    vis.visit((EvalTestExpExp)this, arg);
}
	   ...
	   switch (field) {
        ...
        default:
         fisher.util.Doom.internalCatastrophe("bad field number in internalReplace", this, field, index, newval);
          ...
          public String genericName(){return "EvalTestExpExp";}
        
public Syntax internalDeepCopy(Token start, Token end)  {
Syntax copy = new EvalTestExpExp(start, end, 
