/* Generated By:JavaCC: Do not edit this line. FisherParserTokenManager.java */
...
public class FisherParserTokenManager implements FisherParserConstants
{
...
public FisherParserTokenManager(SimpleCharStream stream){
   if (SimpleCharStream.staticFlag)
      throw new Error("ERROR: Cannot use a static CharStream class with a non-static lexical analyzer.");
   input_stream = stream;
}
public FisherParserTokenManager(SimpleCharStream stream, int lexState){
   this(stream);
   SwitchTo(lexState);
}
