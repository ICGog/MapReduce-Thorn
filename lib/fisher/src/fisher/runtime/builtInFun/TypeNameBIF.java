...
public  class  TypeNameBIF extends BuiltInFunctionTh  { static String copyright() { return fisher.util.Copyright.IBM_COPYRIGHT; }
  

	@Override
	public Thing apply(Thing[] args, Framelike ignoredFrame, Evaller evaller, Syntax src) throws FisherException {
		checkNumberOfArgs(1,1, "()", args, evaller, ignoredFrame, src);
		return EvalUtil.kind(args[0]);
	}
