...
public class RunThorn {
	...
	public static void main(String[] args) {
		try {
			spawnLocallyFromFile(IntTh.of(4334),
					new File("/Users/bard/thorn/tmp/spawnie/startch.th"),
					Bard.list(new File("/Users/bard/thorn/tmp/spawnie/Modules.thm")),
					null
					);
	...
	public static ComponentTh spawnLocallyFromFile(Thing port, File thornFile, List<File> thornModuleList, Thing arguments) throws FisherException {
		RunThorn runThorn = new RunThorn();
	...
	public void parseEverything() throws FisherException {
		...
		FisherParser parser = spawnSrc.parser();
		try {
			final Syntax parsed = SyntacticClass.SPAWN_OR_COMPONENT.parse(parser, spawnSrc);
